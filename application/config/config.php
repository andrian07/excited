...
$config['base_url']    = 'http://localhost/excited';
$config['header'] = "excited/application/views/pages/header.php";
$config['headerdetail'] = "excited/application/views/pages/headerdetail.php";
$config['footer'] = "excited/application/views/pages/footer.php";
